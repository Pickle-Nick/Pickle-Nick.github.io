...
function greeter(hour) {
    ...
    if (hour === 0 || hour <= 11) {
        console.log("Good Morning!");// if hour is 0 or less than or equal to 11 print good morning
    }
    else if (hour === 12 || hour <= 16) {
        console.log('Good Afternoon!');// if hpur is between 12 and 16 inclusive print good afternoon
    }
    else if (hour === 17 || hour <= 21) {
        console.log("Good Evening!"); // if hpur is between 17 21 inclusinve print good evening
    }
    else {
        console.log("Good Night!"); // if anything else print good night
    }
